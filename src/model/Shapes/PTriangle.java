...
public class PTriangle implements IShape {
    ...
    public void draw(Object canvas) {
        ...
        graphicsContext.fillPolygon(
                new double[]{
                        properties.get("x") + (properties.get("width") / 2.0),
                        properties.get("x"),
    ...
    public Object clone() throws CloneNotSupportedException {
        PTriangle newTriangle = new PTriangle(
                getProperties().get("x"),
                getProperties().get("y"),
        ...
        newTriangle.setBackColor(getBackColor());
        newTriangle.setStrokeColor(getStrokeColor());
